...
# Ollama Container App - Deployed separately in Phase 3
# This resource is created by the phase3-deploy-ollama.sh script
...
# Ollama role assignment - Created in Phase 3
# This resource is created by the phase3-deploy-ollama.sh script
